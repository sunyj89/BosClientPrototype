...
const mockGoodsSuppliers = [
  {
    ...
    address: '上海市闵行区申长路1588号',
    goodsTypes: ['饮料', '方便面', '休闲食品'],
    qualificationNumber: 'QL2022101',
    status: '正常',
    level: 'A',
    remarks: '主要饮料供应商'
  },
  {
    ...
    address: '天津市西青区津港公路微电子工业区',
    goodsTypes: ['饮料', '方便面'],
    qualificationNumber: 'QL2022102',
    status: '正常',
    level: 'A',
    remarks: '主要方便面供应商'
  },
  {
    ...
    goodsTypes: ['咖啡', '巧克力', '冰淇淋'],
    qualificationNumber: 'QL2022103',
    status: '正常',
    level: 'A',
    remarks: '国际知名食品供应商'
  },
  {
    ...
    address: '上海市松江区九亭镇九新公路908号',
    goodsTypes: ['休闲食品', '薯片'],
    qualificationNumber: 'QL2022104',
    status: '暂停',
    level: 'B',
    remarks: '休闲食品供应商'
  },
  {
    ...
    goodsTypes: ['日用品', '汽车用品', '休闲食品'],
    qualificationNumber: 'QL2022105',
    status: '正常',
    level: 'A',
    remarks: '关联便利店产品供应商'
  }
...
const GoodsSupplierManagement = () => {
  const [suppliers, setSuppliers] = useState(mockGoodsSuppliers);
  const [filteredSuppliers, setFilteredSuppliers] = useState(mockGoodsSuppliers);
    ...
    form.validateFields().then((values) => {
      ...
      setTimeout(() => {
        if (editingSupplier) {
          ...
          const newSupplier = {
            ...values,
            id: `GS${String(suppliers.length + 1).padStart(3, '0')}`,
          };
  ...
  return (
    <div className="goods-supplier-management">
