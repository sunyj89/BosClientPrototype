...
const DeviceDetail = () => {
  ...
  const fetchDeviceData = () => {
    ...
    try {
      ...
      console.error("获取液位仪数据出错:", error);
      message.error("获取液位仪数据失败，请刷新页面重试");
      setLoading(false);
    }
  };
  ...
  return (
    <div className="device-detail">
      ...
      <Row gutter={16} style={{ marginBottom: 16 }}>
        <Col span={24}>
          <Space>
            <Link to="/equipment/liquid-level-meter">
              <Button icon={<RollbackOutlined />}>返回液位仪列表</Button>
            </Link>
            <Button 
              type="primary" 
              icon={<ReloadOutlined />} 
      ...
      <div className="device-detail-tabs">
        <Tabs defaultActiveKey="maintenance">
          ...
          <TabPane tab="历史趋势" key="trend">
            <Card title="液位仪历史数据趋势" bordered={false}>
              <Row gutter={[16, 16]}>
                <Col span={24}>
      ...
      >
        <Tabs defaultActiveKey="maintenance">
          <TabPane tab="维护记录" key="maintenance">
            <Card title="液位仪维护记录" bordered={false}>
              <Table 
                dataSource={generateMaintenanceRecords()}
                columns={[
                  {
          ...
          <TabPane tab="告警记录" key="alarm">
            <Card title="液位仪告警历史" bordered={false}>
              <Table
          ...
          <TabPane tab="操作记录" key="operation">
            <Card title="液位仪操作记录" bordered={false}>
              <Table
                columns={[
                  {
                    title: '操作时间',
