  ...
  return (
    <div className="training-management-container">
      ...
      <Card title="演示数据说明" style={{ marginTop: '24px' }}>
        <p>为方便演示，当前培训管理使用的是模拟数据，具体说明如下：</p>
        <ul>
          <li>
            <strong>培训类型：</strong>
            <ul>
              <li>消防安全：消防设备使用、逃生演练等</li>
              <li>操作规程：加油站标准作业程序培训</li>
              <li>应急处置：突发事件处理流程培训</li>
              <li>设备维护：油机、储罐等设备保养</li>
            </ul>
          </li>
          <li>
            <strong>管理模块：</strong>
            <ul>
              <li>安全培训计划：培训安排制定和管理</li>
              <li>安全培训记录：实际培训执行情况记录</li>
              <li>安全会议记录：安全会议纪要和决议</li>
              <li>修改记录：完整的操作历史追踪</li>
            </ul>
          </li>
          <li>
            <strong>数据特点：</strong>
            <ul>
              <li>覆盖各分公司和油站的培训活动</li>
              <li>支持培训计划与记录的关联管理</li>
              <li>包含培训文件、人员名单等附件</li>
              <li>提供批量导出和统计功能</li>
            </ul>
          </li>
          <li>
