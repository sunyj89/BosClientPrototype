  ...
  return (
    <div className="inspection-management-container">
      ...
      <Card title="演示数据说明" style={{ marginTop: '24px' }}>
        <p>为方便演示，当前巡检管理使用的是模拟数据，具体说明如下：</p>
        <ul>
          <li>
            <strong>巡检类型：</strong>
            <ul>
              <li>日常巡检：储罐、加油机、消防设施等日常检查</li>
              <li>专项巡检：环保设施、安全防护等专项检查</li>
              <li>消防巡检：消防器材、应急设施等消防检查</li>
            </ul>
          </li>
          <li>
            <strong>管理模块：</strong>
            <ul>
              <li>巡检任务：任务创建、分配、执行状态跟踪</li>
              <li>NFC标签：电子标签管理、状态监控</li>
              <li>点位维护：巡检点位信息、区域风险等级</li>
              <li>执行统计：各级组织任务完成情况统计</li>
              <li>整改跟踪：问题发现、整改进度管理</li>
              <li>风险分析：风险评估、问题汇总报告</li>
            </ul>
          </li>
          <li>
            <strong>数据覆盖：</strong>
            <ul>
              <li>组织层级：公司、分公司、服务区、油站四级</li>
              <li>点位区域：储存区域、作业区域、设施区域</li>
              <li>风险等级：高风险、中风险、低风险分级管理</li>
            </ul>
          </li>
          <li>
            <strong>功能特色：</strong>
