  ...
  return (
    <div className="maintenance-management-container">
      ...
      <Card title="演示数据说明" style={{ marginTop: '24px' }}>
        <p>为方便演示，当前维修管理使用的是模拟数据，具体说明如下：</p>
        <ul>
          <li>
            <strong>申报单编号：</strong>
            <ul>
              <li>格式：6位数字+英文（如：SG2024001A）</li>
              <li>全局唯一标识，便于查询和追踪</li>
              <li>自动生成，无需手工编号</li>
            </ul>
          </li>
          <li>
            <strong>申报状态：</strong>
            <ul>
              <li><span style={{color: '#faad14'}}>草稿</span>：申报单创建但未提交</li>
              <li><span style={{color: '#1890ff'}}>待审批</span>：已提交等待审批</li>
              <li><span style={{color: '#f5222d'}}>已拒绝</span>：审批不通过</li>
              <li><span style={{color: '#52c41a'}}>已审批</span>：审批通过可施工</li>
            </ul>
          </li>
          <li>
            <strong>施工类型：</strong>
            <ul>
              <li>设备维修：加油机、储罐等设备检修</li>
              <li>安全改造：消防、防雷等安全设施升级</li>
              <li>环保治理：油气回收、废水处理等</li>
              <li>基础设施：站房、罩棚等建筑维护</li>
            </ul>
          </li>
          <li>
            <strong>权限管理：</strong>
            <ul>
              <li>查看权限：所有状态申报单均可查看</li>
              <li>编辑权限：草稿和已拒绝状态可编辑</li>
              <li>删除权限：仅草稿状态可删除</li>
              <li>审批权限：根据施工风险等级确定审批层级</li>
            </ul>
          </li>
        </ul>
      </Card>
