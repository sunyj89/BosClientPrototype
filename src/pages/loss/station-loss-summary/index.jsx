  ...
  return (
    <div className="station-loss-summary">
      ...
      <Card
        ...
        style={{ marginTop: 16 }}
      >
        <p>您可以通过以下方式选择查询条件，以演示不同的数据场景：</p>
        <ul>
          <li><strong>默认查询：</strong> 页面加载时默认显示所有油站的汇总数据，日期范围为本月1日至昨天。</li>
          <li><strong>汇总查询：</strong> 在“查询模式”中选择“汇总查询”，可以查看所有油站按日期的汇总损溢数据。</li>
          <li><strong>单站查询：</strong> 在“查询模式”中选择“单站查询”，然后在“选择油站”下拉框中选择一个油站（例如：南昌高速服务区加油站），即可查看该油站多天的详细损溢数据。</li>
          <li><strong>自定义日期查询：</strong> 您可以选择任意日期范围进行查询，系统会根据所选日期范围模拟生成数据。</li>
        </ul>
      </Card>
    </div>
  );
