...
const OilCategory = ({ setLoading }) => {
  ...
  // 更新油品列表数据 - 根据提示词记录修正分类结构
  const mockOilList = [
    { code: '100001', name: '92号汽油国V', category: '92号', categoryKey: '1-1-1' },
    { code: '100002', name: '92号汽油国VIA', category: '92号', categoryKey: '1-1-1' },
    { code: '100003', name: '95号汽油国V', category: '95号', categoryKey: '1-1-2' },
    { code: '100004', name: '95号汽油国VIA', category: '95号', categoryKey: '1-1-2' },
    { code: '100005', name: '98号汽油国V', category: '98号', categoryKey: '1-1-3' },
    { code: '100006', name: '0号柴油国V', category: '0号', categoryKey: '1-2-3' },
    { code: '100007', name: 'LNG液化天然气', category: 'LNG液化天然气', categoryKey: '2-1-1' },
    { code: '100008', name: 'CNG压缩天然气', category: 'CNG压缩天然气', categoryKey: '2-1-2' },
    { code: '100009', name: '桶装车用尿素', category: '桶装车用尿素', categoryKey: '3-1-1' },
    { code: '100010', name: '散装车用尿素', category: '散装车用尿素', categoryKey: '3-1-2' }
  ];
