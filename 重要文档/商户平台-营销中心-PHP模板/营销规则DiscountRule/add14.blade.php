            ...
            computed:{
                ...
                showPrice(){
                    if(this.selectGoodsByClass.length){
                        ...
                        if(this.objType == 1 && this.oilAndGoodsList.length && !this.oilAndGoodsList.some(item=>item.SKU)){ 
                            return false
                        }else if(this.objType == 2 && this.ProhibitGoodsList.length && !this.ProhibitGoodsList.some(item=>item.SKU)){
                            return false
                        }else{
                            return true
                        }
