...
<div id="priceMarketing">
    <div id="typeBox" v-show="isShowTypeBox">
        <ul class="nameList">
            <li @click="changeName(index)" v-for="(name,index) in nameList" :key="index" :class="index==nameIndex?'on':''">@{{name}}</li>
            <el-tooltip class="tipsHeader" placement="right" effect="light">
                <div slot="content">
                    <h6 style="padding: 10px 0;color: #32AF50;">营销引擎：</h6>
                    <p>
                    对于整笔或明细单笔订单支持多维度规则的营销配置如集团下各站、支付方式、会员等级、卡组或车队、专车身份、周月日时间段按不同阶梯范围的订单金额进行整单直降、折扣、返券、返赠、每满直降、每满折扣、单价锁定、充值直降的优惠规则；</p>
                    <h6 style="padding: 10px 0;color: #32AF50;">整单营销：</h6>
                    <p>
                    1. 整单营销针对整笔订单总金额，如一笔订单总金额230元包含92#30升200元和咖啡5支30元，对整笔订单总金额230元进行整单直降、折扣、返券、返赠的营销规则；</p>
                    <p>2. 整单营销配置优惠明细时仅针对整单配置优惠，而不可对于不同商品或支付方式配置不同优惠区间；</p>
                    <p>3. 整单没有单价锁定</p>
                    <p style="color:red;">4. 合并支付仅支持整单营销规则</p>
                    <h6 style="padding: 10px 0;color: #32AF50;">明细营销：</h6>
                        <p>5. 明细营销针对单笔订单，如单笔订单为92#30升200元 或单笔订单 咖啡5支30元，对单笔订单单价6.67元/升进行折扣、直降、单价锁定、充值直降，对单笔订单金额进行返券、返赠、每满直降、每满折扣的营销规则；</p>
                        <p>6. 明细营销配置优惠明细时可对于不同油品或商品配置不同支付方式配置不同区间的按原价或按数量的优惠区间；</p>
                </div>
                <i  type="primary" size="10" class="el-icon-question"></i>
            </el-tooltip>
            <span style="color:red;padding-left:20px;">仅支持喂通卡和喂油OS，SaaS端营销支持敬请期待！</span>
        </ul>
        <div class="tabBox" v-show="nameIndex==0">
            <ul class="typeList">
                <li @click="toAddRule(5)">
                    <img src="/img/discountRule/icon_1.png" />
                    <div class="box">
                        <div class="title">整单直降</div>
                        <div class="box-detail" >例：整单满200元或满30升，整单直降10元</div>
                    </div>
                </li>
                <li @click="toAddRule(6)">
                    <img src="/img/discountRule/icon_2.png" />
                    <div class="box">
                        <div class="title">整单折扣</div>
                        <div class="box-detail" >例：整单满200元或满30升，油款98折</div>
                    </div>
                </li>
                <li @click="toAddRule(7)">
                    <img src="/img/discountRule/icon_3.png" />
                    <div class="box">
                        <div class="title">整单返券</div>
                        <div class="box-detail" >例：整单满200元或满30升，满额返券</div>
                    </div>
                </li>
                <li @click="toAddRule(8)">
                    <img src="/img/discountRule/icon_4.png" />
                    <div class="box">
                        <div class="title">整单返赠</div>
                        <div class="box-detail" >例：整单满200元或满30升，满额返赠</div>
                    </div>
                </li>
        ...
        <div  class="tabBox"  v-show="nameIndex==1">
            <h5 class="typeHead">油品营销</h5>
            <ul class="typeList">
                <li @click="toAddRule(1)">
                    <img src="/img/discountRule/icon_1.png" />
                    <div class="box">
                        <div class="title">明细折扣</div>
                        <div class="box-detail" >例：加油满200元或满30升，单价98折</div>
                    </div>
                </li>
                <li @click="toAddRule(2)">
                    <img src="/img/discountRule/icon_2.png" />
                    <div class="box">
                        <div class="title">明细直降</div>
                        <div class="box-detail">例：加油满200元或满30升，每升优惠0.2元</div>
                    </div>
                </li>
                <li @click="toAddRule(9)">
                    <img src="/img/discountRule/icon_3.png" />
                    <div class="box">
                        <div class="title">明细返券</div>
                        <div class="box-detail" >例：加油满200元或满30升，满额返券</div>
                    </div>
                </li>
                <li @click="toAddRule(10)">
                    <img src="/img/discountRule/icon_4.png" />
                    <div class="box">
                        <div class="title">明细返赠</div>
                        <div class="box-detail" >例：加油满200元或满30升，满额返赠商品</div>
                    </div>
                </li>
                <li @click="toAddRule(3)">
                    <img src="/img/discountRule/icon_6.png" />
                    <div class="box">
                        <div class="title">单价锁定 <span class="title-tips">喂通卡专享</span></div>
                        <div class="box-detail" >例：油品单价锁价6.5元/升</div>
                    </div>
                </li>
                <li @click="toAddRule(4)">
                    <img src="/img/discountRule/icon_5.png" />
                    <div class="box">
                        <div class="title">充值直降 <span class="title-tips">喂通卡专享</span></div>
                        <div class="box-detail" >例：储值卡充值满1000元，每升优惠0.1元</div>
                    </div>
                </li>
               
            </ul>
            <!--非油-->
            <h5 class="typeHead" id="retail-head">非油品营销</h5>
            <ul class="typeList" id="retail-list">
                <li @click="toAddRule(11)">
                    <img src="/img/discountRule/icon_11.png" />
                    <div class="box">
                        <div class="title">明细折扣</div>
                        <div class="box-detail" >例：润滑油满200元或3支，打92折</div>
                    </div>
                </li>
                <li @click="toAddRule(12)">
                    <img src="/img/discountRule/icon_12.png" />
                    <div class="box">
                        <div class="title">明细直降</div>
                        <div class="box-detail" >例：润滑油满200元或3支，每件优惠3元</div>
                    </div>
                </li>
                <li @click="toAddRule(13)">
                    <img src="/img/discountRule/icon_13.png" />
                    <div class="box">
                        <div class="title">明细返券</div>
                        <div class="box-detail" >例：润滑油满200元或3支，满额返券</div>
                    </div>
                </li>
                <li @click="toAddRule(14)">
                    <img src="/img/discountRule/icon_14.png" />
                    <div class="box">
                        <div class="title">明细返赠</div>
                        <div class="box-detail" >例：润滑油满200元或3支，满额返赠商品</div>
                    </div>
                </li>
                <li @click="toAddRule(17)">
                    <img src="/img/discountRule/icon_15.png" />
                    <div class="box">
                        <div class="title">每满折扣 </div>
                        <div class="box-detail" >例：润滑油每满10支/元打95折</div>
                    </div>
                </li>
                <li @click="toAddRule(16)">
                    <img src="/img/discountRule/icon_15.png" />
                    <div class="box">
                        <div class="title">每满直降 </div>
                        <div class="box-detail" >例：润滑油每满200元或3支，减10元</div>
                    </div>
                </li>
                
                <li @click="toAddRule(15)">
                    <img src="/img/discountRule/icon_15.png" />
                    <div class="box">
                        <div class="title">单价锁定 <span class="title-tips">喂通卡专享</span></div>
                        <div class="box-detail" >例：润滑油单价锁价50元/每支</div>
                    </div>
                </li>
    ...
    <div  class="priceMarketing" v-show="!isShowTypeBox">
        ...
        <div>
            ...
            <div v-show="showBaseInfo">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="商品类型" required v-if="showRuleMethods">
                        <el-radio-group v-model="submit.rule_discount_method" >
                          <el-radio :label="2">全部</el-radio>
                          <el-radio :label="0">油品</el-radio>
                          <el-radio :label="1">非油品</el-radio>
                        </el-radio-group>
                    </el-form-item>
                    <el-form-item v-show="identity_list.length>0" required label="专车身份">
                    ...
                    <el-form-item v-if="ruleType!=5 && ruleType!=6" label="优惠油品" required>
                ...
                <div v-for="(item,index) in submit.rule_discount">
                    ...
                    <div class="detail-main">
                        <div class="item" v-for="(cal,calIndex) in item.calculationInterval" :key="'calculationInterval'+calIndex">
                            <div v-if="ruleType!=5 && ruleType!=6">
                            ...
                            <div id="box">
                                <div class="input-box" v-for="(time,timeIndex)  in cal.calculation" :key="'calculation'+timeIndex">                         
                                    <span>大于等于</span>
                                    <el-input-number v-model="time.StartNum" style="margin:0 10px" :min="0" :max="99999.99" :precision="2" :step="1" controls-position="right"></el-input-number>
                                    <span>小于</span>
                                    <el-input-number v-model="time.EndNum" style="margin:0 10px" :min="0" :max="99999.99"  :precision="2" :step="1" controls-position="right"></el-input-number>
                                    ...
                                    <span>
                                        ...
                                        ，
                                        <span v-if="ruleType==1">享受</span>
                                        <span v-else-if="ruleType==2">每升直降</span>
                                        <span v-else-if="ruleType==5">整单直降</span>
                                        <span v-else-if="ruleType==6">整单享受</span>
                                     
                                    </span>
                                    <!-- 校验折扣 -->
                                    <template v-if="ruleType==1  || ruleType==6 ">
                                        <el-form-item
                                         ...
                                         >
                                            <el-input v-model="time.CalculationNum" style="width:130px;margin:0 10px"></el-input>折 <span style="color:red">(示例:享受9.5折)</span>
                                        </el-form-item>
                                    </template>
                                    <!-- 校验金额 -->
                                    <template v-else-if="ruleType==2 || ruleType==5">
                                        <el-form-item
                                          style="margin-bottom: 0"
                                          :prop="'rule_discount.' + index + '.calculationInterval.'+ calIndex+ '.calculation.' + timeIndex + '.CalculationNum'"
                                          :rules="{
                                         ...
                                         >
                                            <el-input v-model="time.CalculationNum" style="margin:0 10px;width:130px;"></el-input>元
                                        </el-form-item>
                                    </template>
...
@section('footer')
    ...
    <script>
        ...
        var show_menu_if_not_standard = {{$show_menu_if_not_standard}};
        if(show_menu_if_not_standard==0){
            $('#retail-head').hide()
            $('#retail-list').hide()
        }
        ...
        var $Main = new Vue({
            ...
            data() {
                ...
                var validateDiscount= (rule, value, callback) => {
                    if (value === '') {
                    callback(new Error(' 请输入介于0到10之间的正确数值，例9.5折，限两位小数'));
                    } else {
                        var regex = /^(0\.\d{1,2}|[1-9](\.\d{1,2})?)$/;
                ...
                return {
                    ...
                    validateDiscount:validateDiscount, // 校验规则
                    nameList:["整单营销","明细营销"],
                    nameIndex:0,
                    ruleType:"",
                    isShowTypeBox:true,
                    ...
                    submit:{
                        ...
                        "rule_type": 0,                      			//规则类型
                        "rule_discount_method": 0,           	 		//规则优惠类型 0油品 1非油品 2全部
            ...
            mounted() {
                ...
                $(".typeList li").on("mouseenter",function(){
                    $(this).addClass("on");
                })
                $(".typeList li").on("mouseleave",function(){
                    $(this).removeClass("on");
                })
            ...
            methods: {
                ...
                getStationChannel(){
                    ...
                    console.log(this.submit.selection_stids)
                    var that  = this;
                ...
                toAddRule(index){
                    ...
                    /*明细直降 */     
                        ...
                        this.submit.rule_type = 1;
                        this.submit.rule_discount_method = 0;
                        this.submit.rule_discount_type = 1;
                        this.submit.rule_discount_detailed_type = 0;

                        this.CalculationType = "-";
                        this.ISGive = false;
                    } else if (index == 3) {
                      window.location.href = "/CardMarketing/ruleCreation?type=1";
                    } else if (index == 4) {
                      window.location.href = "/CardMarketing/ruleCreation?type=2";
                    ...
                    /*整单折扣 */ 
                        ...
                        window.location.href = "/CardMarketing/ruleCreation?type="+index;
                    }
                ...
                baseNext() {
                    ...
                    /*
                        整单不需要优惠油品
                    */
                    if(this.ruleType!=5 && this.ruleType!=6 && this.form.oilsList.length==0){
                  ...
                  this.$refs.detailForm.validate((valid) => {
                    ...
                    this.submit.rule_discount.forEach(function(item){
                        ...
                        item.calculationInterval.forEach(function(cal){
                            ...
                            if(that.ruleType!=5 && that.ruleType!=6  && cal.PayMethod.length==0){
                                that.$message.error('请选择支付方式！');
                                isNext = false;
                                throw new Error("ending");//报错，就跳出循环
                            }
                            if(that.ruleType!=5 && that.ruleType!=6  && cal.oilAndGoods.length==0){
                    ...
                    data.rule_discount.forEach(function(item){
                        item.calculationInterval.forEach(function(item2){
                            ...
                            item2.calculation.forEach(function(calcu){
                               if(that.ruleType==1 || that.ruleType==6 ){
                                let num1 = new BigNumber('10')
                                let num2 = new BigNumber(String(calcu.CalculationNum))            
                                calcu.CalculationNum= num2.dividedBy(num1).toString()
                               }
