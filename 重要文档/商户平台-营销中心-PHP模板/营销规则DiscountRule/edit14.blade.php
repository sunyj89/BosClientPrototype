...
<div id="priceMarketing">
                        ...
                        <div class="item" v-for="(cal,calIndex) in item.calculationInterval" :key="'calculationInterval'+calIndex">
                            ...
                            <div id="box">
                                <div class="input-box" v-for="(time,timeIndex)  in cal.calculation" :key="'calculation'+timeIndex">                         
                                    ...
                                    <span >
                                        <div class="coupon_select select" @click="showSelectGoods(time,3)" type="0">
    ...
    <el-dialog  title="已选择非油商品列表"  append-to-body :visible.sync="selectGoodsDialogVisible" width="1080px" @closed="closeClass">
        <div>
            ...
            <el-button type="primary" @click="showGoods('class')" v-if="!isGiveGoods">选择类</el-button>
        </div>
        <div style="height:500px;">
            ...
            <div v-if="objType==3">
                ...
                <el-table-column    prop="isSelected"    label="默认赠送商品"    >
                    <template slot-scope="scope" >
        ...
        var $Main = new Vue({
            ...
            methods: {
                ...
                baseNext() {
                    ...
                    console.log('edit14:1118',that.isChangeTime)
                ...
                showSelectGoods(obj,num){
                    ...
                    if(that.objType==3){
                        that.isGiveGoods = true
                        obj.giveGoodsList.forEach(function(item,index){
                            _selectGoodsList[index] = {
                                "isSelected":(item.ISDefault=="true" || item.ISDefault==true) ?true:false,
                                "BarCode": item.SKU,
                ...
                showGoods(e){
                    ...
                    if(this.objType == 1 || this.objType == 3){
            ...
            computed:{
                ...
                showPrice(){
                    if(this.selectGoodsByClass.length){
                        ...
                        if(this.objType == 1 && this.oilAndGoodsList.length && !this.oilAndGoodsList.some(item=>item.Type == 1)){ 
                            return false
                        }else if(this.objType == 2 && this.ProhibitGoodsList.length && !this.ProhibitGoodsList.some(item=>item.Type == 1)){
                            return false
                        }else{
                            return true
                        }
