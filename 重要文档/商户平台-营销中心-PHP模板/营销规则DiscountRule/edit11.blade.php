    ...
    <div  class="priceMarketing" >
        ...
        <div>
            ...
            <div v-show="showdetail" class="detail">
                ...
                <div style="color:red;margin-bottom:10px;">（以单个商品满足以下条件可享受折扣，而不是选择的多个商品合计订单金额计算）</div>
        ...
        var $Main = new Vue({
            ...
            methods: {
                ...
                baseNext() {
                    ...
                    console.log('edit11:1102',that.isChangeTime)
            ...
            watch:{
                ...
                oilAndGoodsList(newV){
                    console.log('oilAndGoodsList的变化',newV);
                ...
                ProhibitGoodsList(newV){
                    console.log('ProhibitGoodsList的变化',newV);
                    if(!this.selectGoodsByClass.length){
                        if(newV.some(item=>item.Type == 1)){
                ...
                selectGoodsByClass(newV){
                    console.log('selectGoodsByClass的变化',newV);
                    if(newV.length){
