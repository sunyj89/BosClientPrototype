        ...
        var $Main = new Vue({
            ...
            methods: {
                ...
                baseNext() {
                    ...
                    console.log('edit:1157',that.isChangeTime)
                            ...
                            element.calculationInterval.map(function(cal,index2){
                                cal.calculation.map(function(calcula,index3){
                                    if(that.ruleType==1 || that.ruleType==6){
                                        ...
                                        let num2 = new BigNumber(String(calcula.CalculationNum))
                                        that.submit.rule_discount[index].calculationInterval[index2].calculation[index3].CalculationNum = num1.times(num2).toString();
                                    }else{
