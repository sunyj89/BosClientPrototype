    ...
    <div  class="priceMarketing" >
        ...
        <div>
            ...
            <div v-show="showdetail" class="detail">
                ...
                <div style="color:red;margin-bottom:10px;">（以单个商品满足以下条件可享受直降优惠，而不是选择的多个商品合计订单金额计算）</div>
                        ...
                        <div class="item" v-for="(cal,calIndex) in item.calculationInterval" :key="'calculationInterval'+calIndex">
                            ...
                            <div id="box">
                                <div class="input-box" v-for="(time,timeIndex)  in cal.calculation" :key="'calculation'+timeIndex">                         
                                    ...
                                    >
                                    <span >
                                        <el-input v-model="time.CalculationNum" style="width:130px;margin:0 10px"></el-input>元/个
                                    </span>
                                    </el-form-item>
        ...
        var $Main = new Vue({
            ...
            methods: {
                ...
                baseNext() {
                    ...
                    console.log('edit12:1102',that.isChangeTime)
