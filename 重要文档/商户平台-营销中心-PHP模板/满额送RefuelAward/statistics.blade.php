...
<div id="app">
	...
	<div class="superBody_navLocal superBody_navLocal2">
		<div>
			@{{name}}的数据概览<span class="size12_999 mlr10 font-weight">( 更新时间@{{filterTime()}} )</span> 
		</div>
    ...
    <div>
    	<div class="statistics_title">活动用户统计</div>
    	<ul class="statistics_ul clear">
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.num}}</span>
    		...
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.u_num}}</span>
    		...
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.get_num}}</span>
	    				<span class="size12_999">人</span>
	    			</div>
    			</div>
    		</li>
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.user_use_num}}</span>
	    				<span class="size12_999">人</span>
	    			</div>
    			</div>
    		</li>
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.consumption}}</span>
	    				<span class="size12_999">%</span>
	    			</div>
    			</div>
    		</li>
    	</ul>
    	...
    	<div class="statistics_title">活动券统计</div>
    	<ul class="statistics_ul clear">
    		<li>
    			<div class="statistics_li">
    				<div class="statistics_ul_top">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.coupon_num}}</span>
	    				<span class="size12_999">张</span>
	    			</div>
    			</div>
    		</li>
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.send_coupon_price}}</span>
    		...
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.coupon_use_num}}</span>
	    				<span class="size12_999">张</span>
	    			</div>
    			</div>
    		</li>
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.use_coupon_price}}</span>
	    				<span class="size12_999">元</span>
	    			</div>
    			</div>
    		</li>
    		<li>
    			<div class="statistics_li">
	    			...
	    			<div class="statistics_index_number">
	    				<span class="size34_1996FA" :style="fontSize">@{{listData.Voucher}}</span>
	    				<span class="size12_999">%</span>
	    			</div>
    			</div>
    		</li>
    	</ul>
    	<div class="statistics_title" style="display:none">活动微信红包计</div>
    	<ul class="statistics_ul clear"  style="display:none">
    		<li>
    			<div class="statistics_li">
    				<div class="statistics_ul_top">
    				微信红包发放数量
...
@section('footer')
   ...
   <script src="/js/lodash.min.js?v={{config('constants.wcc_file_version')}}"></script>
   <script src="/js/vendor/Plug/Plug.js?v={{config('constants.wcc_file_version')}}"></script>
   <script>
   // RefuelAward/getStatistics
	 	...
	 	methods:{
            filterTime() {
	 		...
	 		exporFun:function  () {
	 			...
	 			window.location.href ='/RefuelAward/explodeActivity?refuel_id='+this.refuel_id;
	 		},
	 		ajax:function () {
	 			var This = this;
	 			This.boolean = true;
		 		...
		 		$.ajax({
		 			...
		 			success:function (data) {
		 				if (data.status==200) {
							...
							console.log("=>(statistics.blade.php:299) data.data", data.data,data.data.use_coupon_price,_.isNaN(data.data.use_coupon_price), _.isNil(data.data.use_coupon_price));

							data.data.send_coupon_price=(_.isNaN(data.data.send_coupon_price) || _.isNil(data.data.send_coupon_price) || data.data.send_coupon_price === 'NaN')?'':data.data.send_coupon_price;
							data.data.use_coupon_price=(_.isNaN(data.data.use_coupon_price) || _.isNil(data.data.use_coupon_price) || data.data.use_coupon_price === 'NaN')?'':data.data.use_coupon_price;
