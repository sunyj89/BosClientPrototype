...
<div id='app' v-cloak >
	...
	<div class="info_box clear" :Mask="status" v-show="listaState==0&&!successBoolen">
		...
		<div class="clear mt20">
			...
			<div  class="info_box_right ml20">
				<!-- <input class="wcc_input w167" type="text" :class="{wcc_input_error : errorOne.activityNameB}" v-on:focus=" verify('errorOne','activityNameB')  " v-model="One.activityNameLeft" placeholder="请输入左边标题"> -->
				<div class="info_input_limit" >
				...
				<!-- <input class="wcc_input w167" type="text" :class="{wcc_input_error : errorOne.activityNameB}" v-on:focus=" verify('errorOne','activityNameB') " v-model="One.activityNameRight" value="" placeholder="请输入左边标题"> -->
			</div>
		</div> 
		<div class="wcc_error_box ml80" v-if="errorOne.activityNameB">
		    <div class="wcc_error"> 
		        <span class='iconfont'><i>&#xe674;</i></span> 
		        <span>@{{errorOne.activityNameRight}}</span>
		     </div>
		</div>
		<div class="clear mt20">
		...
		<div class="clear mt20">
			...
			<div  class="info_box_right2 ml20">
				...
				<span class="wcc_text inline_block" style="display:block" v-on:click=" One.Rules = One.Rules2">恢复默认</span>
			</div>
		</div>
	...
	<div class="info_box clear" :Mask="status" v-show="listaState==1&&!successBoolen">
		...
		<div class="clear mt20">
			...
			<div  class="info_box_right ml20" style="line-height: 40px;">
			<!-- <div  class="info_box_right info_box_left ml20 font_9_14" v-if="is_baoJi == 1">
				经油站认证的代理商
			</div>
			<div v-else  class="info_box_right info_box_left ml20 font_9_14" > -->
	...
	<div class="info_box clear" :Mask="status" v-show="listaState==2&&!successBoolen">
		...
		<div class="clear mt20">
			...
			<div  class="info_box_right ml20 box" style="height:auto;">
				<div style="height:40px;">
					<select-radio v-bind:add="awardSetting" class="w185" v-if="Three.issueInvitationState>-1" tempkey="Three" v-bind:select="awardSetting[Three.issueInvitationState]" v-on:selected="selectRadioFun" v-bind:search-input="false" v-bind:radio='Three.issueInvitationState'></select-radio>
				</div>
	...
	<div class="info_box clear" :Mask="status" v-show="listaState==3&&!successBoolen">
		...
		<div v-show="Four.rewardCheckbox" class="clear mt10" v-for=" (item,index) in Four.rewardAttr ">
			...
			<div  class="info_box_right2 wcc_text_red1_none  font_9_14 box" >
				成功邀请第<input type="text" v-model="item.condition" v-on:focus=" verify('errorFour','rewardAttr') "   v-on:input="ev_numberInputLimit($event.target , 'condition' ,item)" class="wcc_input w60"> 人，
				...
				<div class="ml20" v-show="item.type == 1">
					<span>奖励</span>
					<input type="text" name=""  v-model="item.number" v-on:focus=" verify('errorFour','rewardAttr') "  v-on:input="ev_numberInputLimit($event.target ,'number',item)" class="wcc_input w60" >
					<span>个积分</span>
				</div>
				...
				<div v-if="status!=1" class="wcc_text_green ml20" v-on:click="add(item,'rewardAttr',index)">添加</div>
	...
	<div class="info_box clear" :Mask="status" v-show="listaState==6&&!successBoolen">
		...
		<template v-if="is_baoJi==1 && One.activityType==2">
			<div class="clear mt20">
		...
		<div class="clear mt20"  v-if="Seven.radio==2">
			...
			<div  class="info_box_right ml20 box">
				在接收邀请的<input  :value="Seven.dayNumber" v-on:focus="verify('errorSeven','dayNumber')" v-on:input="ev_numberInputLimit($event.target ,'dayNumber',Seven)" class="wcc_input w80" type="text">天内
			</div>
		</div> 
		...
		<div class="clear mt20" v-for="(item,index) in Seven.threshold" v-if="Seven.radio==2">
			...
			<div  class="info_box_right2 ml20 box" >
				<div class="box">
					...
					<span class="wcc_text_green wcc_text_red ml20" v-on:click="rewardDelete(item,'threshold',index,true)" v-if="Seven.threshold.length>1">删除</span>
				</div>
			</div>
		</div>
		...
		<div class="clear mt40" v-if="status!=1">
			...
			<div  class="info_box_right ml20">
				...
				<bottom :class="{ wcc_btn_fat_allowed : errorSeven.BonBoolen , wcc_btn_thin_green : !errorSeven.BonBoolen } " v-on:click="checkG" > @{{One.activityType == 1?'下一步':'提交'}}</bottom>
			</div>
		</div>
	</div>
	<!-- 2级邀请人_好友成功邀请其他好友 -->
