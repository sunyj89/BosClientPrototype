...
@section('header')
    ...
    <link rel="stylesheet" href="/css/RefuelDiscount/detail.css?v={{config('constants.wcc_file_version')}}" />
@endsection
...
<script src="/js/RefuelDiscount/detail.js?v={{config('constants.wcc_file_version')}}"></script>
@endsection
