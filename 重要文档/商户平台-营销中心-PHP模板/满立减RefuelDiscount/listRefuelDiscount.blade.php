                        ...
                        <tr v-for="item in showData.data">
                            ...
                            <td>
                                <div class="operationContainer">
                                    <a class="operationContainer_edit mlr10" target="_blank" v-bind:href="'/RefuelDiscount/viewEdit?refuel_id=' + item.id">查看</a>
                                </div>
                            </td>
                            <td v-if="showData.status>1">
                                <div class="operationContainer">
{{--                                    <a class="operationContainer_edit mlr10" target="_blank" v-bind:href="'/RefuelDiscount/detail?refuel_id=' + item.id+'&name='+item.name">详情</a>--}}
                                    <a class="operationContainer_edit mlr10" target="_blank" v-bind:href="'/RefuelDiscount/statistics?refuel_id=' + item.id+'&name='+item.name">统计</a>
                                </div>
                            </td>
                        </tr>
                    </template>
            ...
            var $container = new Vue({
                ...
                methods : {
                    ...
                    ev_getData : function(page,status,callback){
	                    ...
	                    $.ajax({
                            url : '/RefuelDiscount/getRefuelDiscountList',
                            type : 'POST',
                            dataType : 'json',
                            data : {
	                            page : page,
