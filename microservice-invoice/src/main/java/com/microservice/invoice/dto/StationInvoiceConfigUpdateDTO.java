 ...
 */
@Data
@Schema(description = "油站发票配置更新DTO")
public class StationInvoiceConfigUpdateDTO implements Serializable {
    ...
    @Schema(description = "配置生效开始时间（仅未生效配置可修改）", example = "2025-01-15T00:00:00")
